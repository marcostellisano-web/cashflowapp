...
def sample_params() -> ProductionParameters:
    return ProductionParameters(
        ...
        prep_end=date(2025, 2, 14),
        wrap_date=date(2025, 4, 25),
        shooting_blocks=[
            ShootingBlock(
                block_number=1,
                episode_numbers=[1, 2],
        ...
        episode_deliveries=[
            EpisodeDelivery(episode_number=1, rough_cut_date=date(2025, 5, 5), delivery_date=date(2025, 6, 6)),
            EpisodeDelivery(episode_number=2, rough_cut_date=date(2025, 5, 12), delivery_date=date(2025, 6, 13)),
            EpisodeDelivery(episode_number=3, rough_cut_date=date(2025, 5, 19), delivery_date=date(2025, 6, 20)),
            EpisodeDelivery(episode_number=4, rough_cut_date=date(2025, 5, 26), delivery_date=date(2025, 6, 27)),
        ],
